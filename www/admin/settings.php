...
// Settings definitions for the BCM Family Portal
$SETTINGS_DEF = [
  'site_title' => [
    'label' => 'Site Title',
    'hint'  => 'Shown in the header and page titles. Defaults to "BCM Family Portal" if empty.',
    'type'  => 'text',
  ],
  'announcement' => [
    'label' => 'Announcement',
  ...
  'login_image_file_id' => [
    'label' => 'Login Image',
    'hint'  => 'Logo displayed on login, registration, and email-link pages. Recommended size: 200px wide.',
    'type'  => 'file',
  ],
  'site_base_url' => [
    'label' => 'Site URL',
...
foreach ($SETTINGS_DEF as $key => $_meta) {
  ...
  if ($key === 'site_title') {
    $default = defined('APP_NAME') ? APP_NAME : 'Tasks';
  } elseif ($key === 'timezone') {
