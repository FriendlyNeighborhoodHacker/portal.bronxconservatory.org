...
<div style="max-width:720px;margin:0 auto;">
  ...
  <p>Please use this form to register and pay tuition if you are a <span class="prompt-em">Bronx resident studying in person</span><?php if (StripeCheckout::isConfigured()): ?> and pay tuition<?php endif; ?>.
